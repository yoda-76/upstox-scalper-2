...
export default function Header() {
  return (
    <div className='flex justify-between h-[60vh] w-[100%] bg-purple-500 px-10 py-20'>
        <div className='flex flex-col justify-between align-bottom  w-1/2 text-white'>
        ...
        <div className=' w-1/2'>some vector img</div>
    </div>
  )
}
